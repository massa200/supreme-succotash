...
button.onclick=function(){
    ...
    let マス15 = '□';sikaku15.textContent=マス15;let マス16 = '□';sikaku16.textContent=マス16;maru15.textContent='';maru16.textContent='';youwin.textContent='';
    batsu1.textContent='';
    ...
    if(横1>=4){youwin.textContent=勝利;}if(縦1>=4){ youwin.textContent=勝利;}
    if(斜1>=4){ youwin.textContent=勝利;} turn =turn-1;turnn.textContent=turn;
    }
    sikaku2.onclick=function(){
    sikaku2.textContent='';let マル2 = '○';maru2.textContent=マル2;
    縦2=縦2+1;横1=横1+1;yoko1.textContent=横1;
    if(横1>=4){ youwin.textContent=勝利;}if(縦2>=4){ youwin.textContent=勝利}
    if(横1>=3){sikaku1.textContent='';let バツ1 = '×';batsu1.textContent=バツ1;}}
    sikaku3.onclick=function(){
    sikaku3.textContent='';let マル3 = '○';maru3.textContent=マル3;
    縦3=縦3+1;横1=横1+1;yoko1.textContent=横1;
    if(横1>=4){ youwin.textContent=勝利;}if(縦3>=4){ youwin.textContent=勝利;}}
    sikaku4.onclick=function(){
    sikaku4.textContent='';let マル4 = '○';maru4.textContent=マル4;
    縦4=縦4+1;横1=横1+1;yoko1.textContent=横1;斜2=斜2+1;turn =turn-1;
    if(横1>=4){ youwin.textContent=勝利;}if(縦4>=4){ youwin.textContent=勝利;}
    if(斜2>=4){ youwin.textContent=勝利;}}
    ...
    if(横2>=4){ youwin.textContent=勝利;}if(縦1>=4){youwin.textContent=勝利;}}
    sikaku6.onclick=function(){
    sikaku6.textContent='';let マル6 = '○';maru6.textContent=マル6;
    縦2=縦2+1;横2=横2+1;斜1=斜1+1;turn =turn-1;
    if(横2>=4){ youwin.textContent=勝利;}if(縦2>=4){ youwin.textContent=勝利;}
    if(斜1>=4){ youwin.textContent=勝利;}}
    sikaku7.onclick=function(){
    sikaku7.textContent='';let マル7 = '○';maru7.textContent=マル7;
    縦3=縦3+1;横2=横2+1;斜2=斜2+1;turn =turn-1;
    if(横2>=4){ youwin.textContent=勝利;}if(縦3>=4){ youwin.textContent=勝利;}
    if(斜2>=4){ youwin.textContent=勝利;}}
    sikaku8.onclick=function(){
    sikaku8.textContent='';let マル8 = '○';maru8.textContent=マル8;
    縦4=縦4+1;横2=横2+1;turn =turn-1;
    if(横2>=4){ youwin.textContent=勝利;}if(縦4>=4){ youwin.textContent=勝利;}}
    sikaku9.onclick=function(){
    sikaku9.textContent='';let マル9 = '○';maru9.textContent=マル9;
    縦1=縦1+1;tate1.textContent=縦1;横3=横3+1;turn =turn-1;
    if(横3>=4){ youwin.textContent=勝利;}if(縦1>=4){ youwin.textContent=勝利;}}
    sikaku10.onclick=function(){
    sikaku10.textContent='';let マル10 = '○';maru10.textContent=マル10;
    縦2=縦2+1;横3=横3+1;斜2=斜2+1;turn =turn-1;
    if(横3>=4){ youwin.textContent=勝利;}if(縦2>=4){ youwin.textContent=勝利;}
    if(斜2>=4){ youwin.textContent=勝利;}}
    sikaku11.onclick=function(){
    sikaku11.textContent='';let マル11 = '○';maru11.textContent=マル11;
    縦3=縦3+1;横3=横3+1;斜1=斜1+1;turn =turn-1;
    if(横3>=4){youwin.textContent=勝利;}if(縦3>=4){ youwin.textContent=勝利;}
    if(斜1>=4){ youwin.textContent=勝利;}}
    sikaku12.onclick=function(){
    sikaku12.textContent='';let マル12 = '○';maru12.textContent=マル12;
    縦4=縦4+1;横3=横3+1;turn =turn-1;
    if(横3>=4){ youwin.textContent=勝利;}if(縦4>=4){youwin.textContent=勝利;}}
    sikaku13.onclick=function(){
    sikaku13.textContent='';let マル13 = '○';maru13.textContent=マル13;
    縦1=縦1+1;tate1.textContent=縦1;横4=横4+1;斜2=斜2+1;turn =turn-1;
    if(横4>=4){ youwin.textContent=勝利;}if(縦1>=4){ youwin.textContent=勝利;}
    if(斜2>=4){ youwin.textContent=勝利;}}
    sikaku14.onclick=function(){
    sikaku14.textContent='';let マル14 = '○';maru14.textContent=マル14;
    縦2=縦2+1;横4=横4+1;turn =turn-1;
    if(横4>=4){ youwin.textContent=勝利;}if(縦2>=4){ youwin.textContent=勝利;}}
    sikaku15.onclick=function(){
    sikaku15.textContent='';let マル15 = '○';maru15.textContent=マル15;
    縦3=縦3+1;横4=横4+1;turn =turn-1;
    if(横4>=4){ youwin.textContent=勝利;}if(縦3>=4){ youwin.textContent=勝利;}}
    sikaku16.onclick=function(){
    sikaku16.textContent='';let マル16 = '○';maru16.textContent=マル16;
    縦4=縦4+1;横4=横4+1;斜1=斜1+1;turn =turn-1;
    if(横4>=4){ youwin.textContent=勝利;}if(縦4>=4){ youwin.textContent=勝利;}
    if(斜1>=4){ youwin.textContent=勝利;}}
